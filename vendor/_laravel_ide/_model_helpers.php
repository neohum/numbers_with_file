...
namespace App\Models {
  ...
  /**
   * App\Models\NumberSchool
   *
   * @property \Illuminate\Support\Carbon|null $updated_at
   * @property \Illuminate\Support\Carbon|null $created_at
   * @property varchar $schoolcode
   * @property varchar $schoolname
   * @property int $id
   * @method static \Illuminate\Database\Eloquent\Builder|NumberSchool whereId($value)
   * @method static \Illuminate\Database\Eloquent\Builder|NumberSchool whereSchoolname($value)
   * @method static \Illuminate\Database\Eloquent\Builder|NumberSchool whereSchoolcode($value)
   * @method static \Illuminate\Database\Eloquent\Builder|NumberSchool whereCreatedAt($value)
   * @method static \Illuminate\Database\Eloquent\Builder|NumberSchool whereUpdatedAt($value)
   * @method static \Illuminate\Database\Eloquent\Builder|NumberSchool newModelQuery()
   * @method static \Illuminate\Database\Eloquent\Builder|NumberSchool newQuery()
   * @method static \Illuminate\Database\Eloquent\Builder|NumberSchool query()
   ...
   */
  class NumberSchool extends \Illuminate\Database\Eloquent\Model
  {
    //
  }

  /**
   * App\Models\NumberSchool1s
   *
   * @property \Illuminate\Support\Carbon|null $updated_at
   * @property \Illuminate\Support\Carbon|null $created_at
   * @property varchar $created_ats
   ...
   * @property varchar $schoolname
   * @property int $id
   * @method static \Illuminate\Database\Eloquent\Builder|NumberSchool1s whereId($value)
   * @method static \Illuminate\Database\Eloquent\Builder|NumberSchool1s whereSchoolname($value)
   * @method static \Illuminate\Database\Eloquent\Builder|NumberSchool1s whereSchoolcode($value)
   * @method static \Illuminate\Database\Eloquent\Builder|NumberSchool1s whereNumber($value)
   * @method static \Illuminate\Database\Eloquent\Builder|NumberSchool1s whereContent($value)
   * @method static \Illuminate\Database\Eloquent\Builder|NumberSchool1s whereFile($value)
   * @method static \Illuminate\Database\Eloquent\Builder|NumberSchool1s whereCreatedAts($value)
   * @method static \Illuminate\Database\Eloquent\Builder|NumberSchool1s whereCreatedAt($value)
   * @method static \Illuminate\Database\Eloquent\Builder|NumberSchool1s whereUpdatedAt($value)
   * @method static \Illuminate\Database\Eloquent\Builder|NumberSchool1s newModelQuery()
   * @method static \Illuminate\Database\Eloquent\Builder|NumberSchool1s newQuery()
   * @method static \Illuminate\Database\Eloquent\Builder|NumberSchool1s query()
   * @method static mixed select($columns)
   * @method static mixed selectSub($query, $as)
   * @method static mixed selectRaw($expression, array $bindings)
   * @method static mixed fromSub($query, $as)
   ...
   * @mixin \Illuminate\Database\Query\Builder
   */
  class NumberSchool1s extends \Illuminate\Database\Eloquent\Model
  {
    //
  }
